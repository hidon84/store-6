const terms = {
  ...
  privacy: `<개인정보 수집·이용 목적 및 수집 항목>
    1. 수집·이용 목적 : 회원 식별, 회원제 서비스 이용 제공, 문의 상담 및 불만 처리, 부정이용 방지, 서비스 만족도 조사, 고지사항 전달, 맞춤 서비스 제공, 휴대폰 본인인증
    수집 항목 : 아이디, 비밀번호, 이름, 휴대전화번호, 이메일주소, 생년월일
    
    2. 수집·이용 목적 : 타사계정을 이용한 회원제 서비스 제공, 간편로그인 서비스 제공
    수집항목 : 제3자로부터 제공받는 개인정보
    - 페이스북 : 이름, 프로필이미지, 페이스북인증 코드 (선택)이메일주소
    
    3. 수집·이용 목적 : 회원관리, 부정거래 기록 확인, 서비스 방문 및 이용기록 통계 및 분석, 신규서비스 개발
    수집 항목 : IP Address, 쿠키, 방문기록, 서비스 이용기록, 기기정보(기기고유번호, OS, 버전, 모델명 등)
    
    4. 수집·이용 목적 : 주문 및 배송서비스 제공
    수집 항목
    - 주문자정보 : 이름, 전화번호, 휴대전화번호, 이메일주소
    - 배송정보 : 수령인 이름, 배송지 주소, 휴대전화번호
    
    <보유 및 이용기간>
    모든 개인정보는 목적달성 후 파기를 원칙으로 합니다.
    - 모든 회원정보는 회원 탈퇴일로부터 5일 후 파기합니다.
    - 배송서비스 제공을 위한 개인정보는 배송완료 후 1개월 뒤 파기됩니다.
    단, 관련법령에 의해 보존하는 경우는 예외로 보관됩니다.
    
    개인정보 수집 및 이용에 동의하지 않으실 수 있으며, 동의하지 않으실 경우 서비스 이용이 제한됩니다.`,
};
